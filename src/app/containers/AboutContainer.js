                        ...
                        <div className="tokyo_tm_short_info w-full h-auto clear-both float-left flex border-solid border-[#DFDFDF] border-b pb-[30px] mb-[40px]">
                            ...
                            <div className="tokyo_tm_info w-full h-auto clear-both float-left">
                                <ul className="m-0 list-none">
                                    ...
                                    <li className="m-0"><span className="min-w-[100px] float-left mr-[10px] font-bold text-black">Email:</span><span><a className="text-[#767676] transition-all duration-300 hover:text-black" href="mailto:tokyo@gmail.com">sergiomanuellio@gmail.com</a></span></li>
                                    <li className="m-0"><span className="min-w-[100px] float-left mr-[10px] font-bold text-black">Phone:</span><span><a className="text-[#767676] transition-all duration-300 hover:text-black" href="tel:+77 022 177 05 05"> <FontAwesomeIcon icon={faViber} /> +63 967 288 7664 | <FontAwesomeIcon icon={faWhatsapp} />
                                     +974 71934862</a></span></li>
                                </ul>
                            </div>
                            </div>
                    ...
                    <div className="container">
                        <div className="in w-full h-auto clear-both float-left flex">
                            ...
                            <div className="tokyo_progress">
                                ...
                                <div className="progress_inner">
                                    <span>
                                        <span className="label">Php / Python / Laravel</span>
                                        <span className="number">
                                        80%
                                        </span>
                                    </span>
                                ...
                                <div className="progress_inner">
                                    <span>
                                        <span className="label">Figma / Adobe XD, Photoshop / Storybook</span>
                                        <span className="number">
                                        70%
                                        </span>
                                    </span>
                            ...
                            <div className="tokyo_progress">
                                ...
                                <div className="progress_inner">
                                    <span>
                                        <span className="label">Redux / Zustand</span>
                                        <span className="number">
                                        70%
                                        </span>
                                    </span>
                                ...
                                <div className="progress_inner">
                                    <span>
                                        <span className="label">Jest / Enzyme</span>
                                        <span className="number">
                                        75%
                                        </span>
                                    </span>
                            ...
                            <div className="tokyo_tm_skill_list w-full h-auto clear-both float-left">
                                <ul className="m-0 knowledge">
                                    <li className="m-0 pl-[25px] relative">
                                        <span>
                                        Bootstrap, Tailwind, Ant Design, Material UI, Shadcn
                                        </span>
                                    </li>
                                    <li className="m-0 pl-[25px] relative">
                                        <span>
                                        Redux, Zustand, NextJS, NuxtJS, Laravel, React Query
                                        </span>
                                    </li>
                                    <li className="m-0 pl-[25px] relative">
                                        <span>
                                        MySQL, MSSQL, PostgreSQL MongoDB, NoSQL
                                        </span>
                                    </li>
                                    <li className="m-0 pl-[25px] relative">
                                        <span>
                                        SCSS, Sass, Less, Figma, Photoshop, Storybook
                                        </span>
                                    </li>
                                    <li className="m-0 pl-[25px] relative">
                                        <span>
                                        Webpack, Babel, Jest, Enzyme, Vite, Jira
                                        </span>
                                    </li>
                                    <li className="m-0 pl-[25px] relative">
                                        <span>
                                        Git, AWS, Azure Devops, Vercel, Docker
                                        </span>
                                    </li>
                                </ul>
                            </div>
